	...
	<section class="ftco-section ">
		<div class="container ">
			...
			<div class="row justify-content-center">
				<div class="col-md-6" style="margin-left: 11.5%;">
			...
			<div class="row justify-content-center">
	            ...
	            <div class="form-group">
	            	<button type="submit" class="form-control btn submit px-3" style="background-color: #f48120;" name="register">Sign Up</button>
	            </div>
	          </form>
              <div class="d-flex justify-content-center links">
					Already have an account? <a href="login.php" style="color: #f48120;">&nbsp; Sign In</a>
				</div>
	          <p class="w-100 text-center" style="margin-top: 5%;">&mdash; Or Sign Up With &mdash;</p>
