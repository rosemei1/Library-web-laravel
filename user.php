...
<html lang="en">
	...
	echo "<h2 style='color:white;'>Anggota Perpustakaan</h2>";
	echo '<table border="1" cellpadding="10" id="bawah" style="background-color: white; ">';
	echo "<tr style='background-color: #195681; '>
				<th style='color:white;border: 1px solid white;'>Nama Depan</th>
				<th style='color:white;border: 1px solid white;'>Nama Belakang</th>
		  	</tr>";
	//jika true
	foreach ($user as $value) { 
		?>
			<tr>
				<td style="border: 1px solid #195681;"><?php echo $value['f_name']; ?></td>
				<td style="border: 1px solid #195681;"><?php echo $value['l_name']; ?> </td>
			</tr>
		<?php
	}
	echo "</table>";
