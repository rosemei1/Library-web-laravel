            ...
            <div id="page-content-wrapper">
                ...
                <header class="masthead">
                    <div class="container px-4 px-lg-5 h-100">
                        ...
                        ?>
                            <div class="card align-items-center" style="width: 18rem; margin-right: 5px; background-color:#195681;">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <a href="ubahbuku.php?id=<?= $value['id'] ?>" class="btn btn-primary">Ubah</a>
                                        <a onclick="return confirm('Apakah anda ingin menghapus data ini ?')" href="delete.php?id=<?= $value['id'] ?>" class="btn btn-danger">Hapus</a>
                                    </div>
                                    <?php
                           echo '</div>';
                        }
